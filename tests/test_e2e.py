...
def test_e2e(test_obj):
    ...
    try:
        ...
        test_obj = PageFactory.get_page_object("home page")
        result_flag = test_obj.decide()
        test_obj.log_result(result_flag,
        positive='Successfully navigated to the product page',
        negative='Could not navigate to the product page')
